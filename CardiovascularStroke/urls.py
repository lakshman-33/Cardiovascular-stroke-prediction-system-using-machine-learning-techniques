...
from CardiovascularStroke import views as view
...
urlpatterns = [
    ...
    path('CardiovascularStroke/', users.CardiovascularStroke, name='CardiovascularStroke'),
    path('CardiovascularStrokePrediction/', users.CardiovascularStrokePrediction, name='CardiovascularStrokePrediction'),
